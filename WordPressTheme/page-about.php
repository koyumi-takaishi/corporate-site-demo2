...
<div class="l-mv p-sub-mv js-sub-mv">
  <picture class="p-sub-mv__img">
    ...
    <img src="<?php echo get_template_directory_uri() ?>/assets/img/about/kv-about-img-sp.jpg" alt="">
  </picture>
...
<section class="l-message p-message">
  <div class="p-message__img">
    <img src="<?php echo get_template_directory_uri() ?>/assets/img/about/ceo-message.jpg" alt="女性が写っている写真">
  </div>
  <div class="l-inner">
